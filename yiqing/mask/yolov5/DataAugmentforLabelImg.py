...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'D:\Taidy\project\yolov5-5.0\VOCdevkit\VOC2007\JPEGImages/')
    parser.add_argument('--source_xml_path', type=str, default=r'D:\Taidy\project\yolov5-5.0\VOCdevkit\VOC2007\Annotations/')
    parser.add_argument('--save_img_path', type=str, default=r'C:\Users\awsless\Desktop\newdata/Images2/')
    parser.add_argument('--save_xml_path', type=str, default=r'C:\Users\awsless\Desktop\newdata/Annotations2/')
